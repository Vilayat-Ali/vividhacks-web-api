...
accountRouter.post("/register/user", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userModel, accessToken, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                ...
                return [4 /*yield*/, userModel.save(function (err) {
                        if (err)
...
accountRouter.delete("/delete/user", auth_1.authenticateUser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var idToBeDeleted, deletedUser, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
